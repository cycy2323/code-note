...
type Props = {};
export default class GameThirdScrollView extends Component<Props> {
    constructor(props){
        super(props);
        this.state = {
            //记录当前偏移量
    ...
    componentWillReceiveProps(pros){
        if (pros.searchStscrollToZeroring===true){
    ...
    _renderRightBtn=()=>{
        ...
        let num =parseInt(datas.length/2.0);
        if (datas.length%2===1){
            num=parseInt(datas.length/2.0)+1;
