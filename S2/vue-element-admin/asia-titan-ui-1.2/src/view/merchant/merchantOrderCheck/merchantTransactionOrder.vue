...
export default {
  ...
  data() {
    return {
      ...
      successAmount: 'merchantOrderCheck:merchant:situation:successAmount',
      successCount: 'merchantOrderCheck:merchant:situation:successCount'
    }
  },
  created() {
    this.getList()
  ...
  methods: {
    ...
    getOrderLists() {
      return exportExcel(this.total, this.listQuery, merchantTransactionOrderList, this)// （总条数，查询条件，接口方法）
    }
  }
}
</script>
