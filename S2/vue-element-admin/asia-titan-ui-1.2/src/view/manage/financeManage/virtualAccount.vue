  ...
  <div class="app-container">
    <el-form :inline="true" :model="listQuery" class="demo-form-inline">
      <el-form-item label="商户账号">
        <el-input v-model="listQuery.userName" clearable style="width: 250px;" @keyup.enter.native="refreshList" />
      </el-form-item>
      ...
      <el-form-item label="商户类型">
        <el-select
          v-model="listQuery.merType"
          placeholder="全部"
          clearable
          style="width: 150px;margin-right: 20px"
          class="filter-item">
          <el-option :value="1" label="普通商户"/>
          <el-option :value="2" label="虚拟商户"/>
        </el-select>
      </el-form-item>
    ...
    <el-table v-loading="listLoading" :key="tableKey" :data="list" border fit highlight-current-row style="width: 100%;">
      ...
      <el-table-column label="商户类型" prop="status" align="center">
        <template slot-scope="scope">
