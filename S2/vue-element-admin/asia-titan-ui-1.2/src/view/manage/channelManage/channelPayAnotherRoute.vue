...
import { fetchList, fetchUpdate, fetchDetail, fetchUpdateBanks, fetchKey, setWeight, channelList, channelUsageType } from '@/api/manage/channelManage/channelPayAnotherRoute'
...
export default {
  ...
  data() {
    return {
      userT: 'manageChannelManage:channelPayAnotherRoute:usesT',
