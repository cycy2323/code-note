  ...
  <div class="withdraw-list app-container">
    <el-form :inline="true" :model="listQuery" class="demo-form-inline">
      ...
      <el-form-item label="邮箱">
        <el-input v-model="listQuery.email" clearable placeholder="请输入邮箱" style="width: 250px;" @keyup.enter.native="refreshList" />
      </el-form-item>
      <el-form-item label="手机号">
        <el-input v-model="listQuery.phone" clearable placeholder="请输入手机号" style="width: 250px;" @keyup.enter.native="refreshList" />
      </el-form-item>
        ...
        <div>
          ...
          <el-form-item label="接口权限">
            <el-checkbox-group v-model="checkList" class="quanxian">
              <el-checkbox label="1">api支付查询</el-checkbox>
              <el-checkbox label="2">api代付查询</el-checkbox>
              <el-checkbox label="3">api支付提交</el-checkbox>
              <el-checkbox label="4">api代付提交</el-checkbox>
...
const permissionList = [
  { label: 'api支付查询', value: '1' },
  { label: 'api代付查询', value: '2' },
  { label: 'api支付提交', value: '3' },
  { label: 'api代付提交', value: '4' },
  { label: 'web支付', value: '6' },
  { label: 'web代付', value: '7' }
]
const statusMap = {
