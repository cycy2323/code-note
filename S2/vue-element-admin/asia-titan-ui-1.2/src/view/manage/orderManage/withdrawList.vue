...
import { fetchList, getDayStatistics, getDaySynchronism, fetchChannelList, getDayReissue, getAgentList, getNotifyList, goReminder } from '@/api/manage/orderManage/withdrawList'
...
export default {
  ...
  data() {
    return {
      ...
      reminder: 'orderManage:withdrawList:reminder',
