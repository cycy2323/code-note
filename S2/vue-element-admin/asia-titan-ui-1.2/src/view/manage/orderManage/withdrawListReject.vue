  ...
  <div class="withdraw-list app-container">
    <el-form :inline="true" :model="listQuery" class="demo-form-inline">
      <el-form-item label="商户ID">
        <el-input v-model.number="listQuery.merId" clearable style="width: 220px;" @keyup.enter.native="refreshList"/>
      </el-form-item>
      <el-form-item label="商户订单号">
        <el-input v-model="listQuery.merOrderNo" clearable style="width: 220px;" @keyup.enter.native="refreshList" />
      </el-form-item>
      <el-form-item label="响应编码">
        <el-input v-model="listQuery.resCode" clearable style="width: 160px;" @keyup.enter.native="refreshList" />
      </el-form-item>
      ...
      <el-form-item label="持卡人姓名">
        <el-input v-model="listQuery.bankUserName" clearable style="width: 160px;" @keyup.enter.native="refreshList" />
      </el-form-item>
      <el-form-item label="银行卡号后六位">
        <el-input v-model="listQuery.bankAftSix" clearable style="width: 160px;" @keyup.enter.native="refreshList" />
      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    dateChange() {
      if (this.qishiDate) {
        this.listQuery.beginSubTime = parseTime(this.qishiDate[0], '{y}-{m}-{d} {h}:{i}:{s}')
        this.listQuery.endSubTime = parseTime(this.qishiDate[1], '{y}-{m}-{d} {h}:{i}:{s}')
      } else {
