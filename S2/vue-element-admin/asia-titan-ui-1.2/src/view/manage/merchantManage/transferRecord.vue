    ...
    <div class="filter-container">
      <el-form :inline="true" :model="listQuery" class="demo-form-inline">
        ...
        <el-form-item label="转出商户ID">
          <el-input v-model.number="listQuery.acceptMerId" :placeholder="$t('table.TransferOutId')" clearable style="width: 240px;" class="filter-item" @keyup.enter.native="handleFilter" />

        </el-form-item>
        <el-form-item label="转入商户ID">
          <el-input v-model.number="listQuery.merId" :placeholder="$t('table.TransferId')" clearable style="width: 230px;" class="filter-item" @keyup.enter.native="handleFilter" />
