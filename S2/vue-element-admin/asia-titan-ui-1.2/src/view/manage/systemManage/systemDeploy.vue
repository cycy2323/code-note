  ...
  <div class="app-container">
    <el-form :inline="true" :model="listQuery" class="demo-form-inline">
      <el-form-item label="字段名称">
        <el-input v-model="listQuery.baseKey" clearable style="width: 240px;" @keyup.enter.native="refreshList" />
      </el-form-item>
      <el-form-item label="字段值">
        <el-input v-model="listQuery.baseValue" clearable style="width: 260px;" @keyup.enter.native="refreshList" />
      </el-form-item>
