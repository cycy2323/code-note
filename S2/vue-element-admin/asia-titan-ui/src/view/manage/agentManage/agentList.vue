  ...
  <div class="app-container">
    <el-form :inline="true" :model="listQuery" class="demo-form-inline">
      <el-form-item label="代理名称">
        <el-input v-model="listQuery.nickName" clearable style="width: 160px;" />
      </el-form-item>
      <el-form-item label="代理ID">
        <el-input v-model="listQuery.id" clearable style="width: 160px;" onkeyup="this.value=this.value.replace(/\D/g,'')"/>
      </el-form-item>
...
import { fetchList, fetchAdd, fetchUpdate, resetPwd } from '@/api/manage/agentManage/agentList'
