<template>
  <div class="app-main-container">
    <el-form :inline="true" :model="listQuery" style="width: 96%;margin-right: auto;margin-left: auto;">
      ...
      <el-form-item size="small" label="下发时间">
        <el-date-picker
          v-model="operateDate"
          type="datetimerange"
          range-separator="至"
    ...
    <el-table
      ...
      <el-table-column prop="orderState" label="代付状态" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column prop="orderState" label="回调状态" align="center">
        <template slot-scope="scope">
          <el-tag :type="scope.row.orderState | orderStatusTagTypeFilter">
            {{ scope.row.orderState | orderStatusFilter }}
          </el-tag>
      ...
      <el-table-column prop="orderState" label="操作" align="center">
        <template slot-scope="scope">
