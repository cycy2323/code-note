  ...
  <div class="app-container">
    <el-form :inline="true" :model="listQuery" class="demo-form-inline filter-container">
      <el-form-item label="代理ID">
        <el-input v-model.number="listQuery.agentId" clearable style="width: 240px;" @keyup.enter.native="refreshList"/>
      </el-form-item>
      <el-form-item label="商户ID">
        <el-input v-model.number="listQuery.merchantId" clearable style="width: 240px;" @keyup.enter.native="refreshList"/>
      </el-form-item>
...
import { fetchList, warningCount } from '@/api/manage/merchantManage/plainBalanceStatistics'
