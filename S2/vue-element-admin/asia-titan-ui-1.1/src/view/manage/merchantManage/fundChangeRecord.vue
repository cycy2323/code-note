  ...
  <div class="withdraw-list app-container">
    <el-form :inline="true" :model="listQuery" class="demo-form-inline">
      <el-form-item label="商户ID">
        <el-input v-model.number="listQuery.merId" clearable style="width: 170px;" @keyup.enter.native="refreshList"/>
      </el-form-item>
      <el-form-item label="外部订单号">
        <el-input v-model="listQuery.businessNo" clearable style="width: 170px;" @keyup.enter.native="refreshList" />
      </el-form-item>
