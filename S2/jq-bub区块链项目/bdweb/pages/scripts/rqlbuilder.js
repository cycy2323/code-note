var RQLBuilder = function()
{
    return {
        ...
        isnull:function(cname){
            //!!<, <=, >, >= , !=, in , not in
            // $lt, $lte, $gt, $gte , $ne ,$in and $nin
            return('"'+cname+'":{"$isnull":""}')
        },
        isnotnull:function(cname){
            //!!<, <=, >, >= , !=, in , not in
            // $lt, $lte, $gt, $gte , $ne ,$in and $nin
            return('"'+cname+'":{"$isnotnull":""}')
        },
...
String.prototype.rqlnoenc = function(){
    return ('{'+this+'}');
}


String.prototype.uricode = function(){
    return encodeURIComponent(this);
}
