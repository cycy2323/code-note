    ...
    return {
        ...
        reload : function(){
            ...
            var bd = {"cols":cols,
                ...
                "c.book_id = b.book_id",
                "wheres":" a.error_type='1' and b.area_id in ("+loginarea.join()+") order by  a.opt_date desc,a.apply_date desc ",
                // "wheres":" a.error_type='1' and a.opt_result = '1' and b.area_id in ("+loginarea.join()+") order by  a.opt_date desc,a.apply_date desc ",
                "page":true,
                "limit":50};
            /* rf= RFTable.init(*/
            ...
            xw = XWATable.init(
                {
                    ...
                    exportxls: {
                        ...
                        remap: {
                            ...
                            "chgType":"1:燃气费,2:垃圾费,",
                            "beforeChange":"db@GAS_CHG_TYPE,chgTypeId,chargeTypeName",
                            "afterChange":"db@GAS_CHG_TYPE,chgTypeId,chargeTypeName"
                    ...
                    findFilter : function(){
                        ...
                        bd = {"cols":cols,
                            ...
                            "b.customer_code= a.customer_code left join gas_mrd_book c on " +
                            "c.book_id = b.book_id",
                            "wheres": sql + " and a.error_type='1' order by  a.opt_date desc,a.apply_date desc",
                            // "wheres": sql + " and a.error_type='1' and a.opt_result = '1' order by  a.opt_date desc,a.apply_date desc",
                            "page":true,
                            "limit":50};
