...
var GasModSys = function() {
	...
	var employeeHelper = RefHelper.create({
        ref_url: 'mfsysuser?query={"status":"1"}',
        ref_col: "userId",
    ...
    return {
        ...
        areaList:function(jsOpts){
            ...
            $.ajax({
                //url: Utils.queryURL(hzq_rest+ "mfsysuser")+'fields={"userId":1,"employeeName":1,'+
        ...
        copyUsersInArea:function(jsOpts){
            ...
            */
            ...
            var query={
                  ...
                  "froms":"gasMrdBook b, mfsysuser u",
        ...
        employeeListForArea:function(jsOpts){
        	...
        	$.ajax({
                url: Utils.queryURL(hzq_rest+ "mfsysuser")+'fields={"userId":1,"employeeName":1}&query='+query,
                dataType: 'json',
                async: false,
            }).done(function(data,retcode) {
                 jsOpts['cb'](data);       
