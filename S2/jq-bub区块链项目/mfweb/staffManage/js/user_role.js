...
var UserRoleAction = function () {
    ...
    var queryCondion = RQLBuilder.and([
        RQLBuilder.equal("businessId",businessId),RQLBuilder.equal("user_type","1")
    ]).rql()
    var userHelper = RefHelper.create({
        ref_url: "mfsysuser?query="+queryCondion,
        ref_col: "userId",
            ...
            this.xw=XWATable.init(
                {
                    ...
                    saveColumn:false,
                    //----------------基本restful地址---
                    restbase: 'mfsysuserrole?query='+queryCondion1,
                    ...
                    coldefs:[
...

                        {
                            ...
                            validate:"required",
                            inputsource: "select",
                            ref_url:  "mfsysrole?query="+queryCondion1,
                            ref_name: "roleName",
                            ref_value: "roleId",
                            index:3
                        },
