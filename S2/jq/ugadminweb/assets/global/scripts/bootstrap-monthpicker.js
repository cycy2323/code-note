    ...
    Monthpicker.prototype = {
        ...
        init: function(options) {
            ...
            this.$dialog = $([
                '<div class="mp-dialog">',
                    '<div class="mp-title">',
                        '<small class="mp-year-prev pull-left"><i class="glyphicon glyphicon-circle-arrow-left"></i></small>',
                        ' <span></span> ',
                        '<small class="mp-year-next pull-right"><i class="glyphicon glyphicon-circle-arrow-right"></i></small>',
                    '</div>',
        ...
        initDate: function() {
            ...
            this.$title.text(this.year+"年");
            this.$content.find('li').removeClass('active').eq(this.month).addClass('active');
