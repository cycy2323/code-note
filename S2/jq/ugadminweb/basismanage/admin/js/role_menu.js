    ...
    return {
        ...
        init: function () {
            typeHelper=RefHelper.create({
                ref_url:'ugsysrole/?query={"roleType":"1"}',
                ref_col:"roleId",
        ...
        initUnitTree : function(){
            ...
            var reloadRolePerm=function(){
                var data = Restful.findNQ("/ugrest/ugsysrolemenu");
            ...
            var buildMenuData=function(){
                ...
                var roleid = $("#sel_rolecode").val();
                    ...
                    var data = Restful.findNQ('/ugrest/ugsysmenu?query={"status":"1"}');
                    var data1 = Restful.findNQ("/ugrest/ugsysrolemenu");
                    //console.log(data);
                    //console.log(data1);
                ...
                console.log("rolemenuId",rolemenuId);
            ...
            $('#save_button').click(function(){
                ...
                console.log("rolemenuId",rolemenuId.join());
                //先删除现有菜单
                var aaa = Restful.delByIDS("/ugrest/ugsysrolemenu",rolemenuId)
                //console.log(aaa);
                ...
                if(senddata.length<=0){
                    senddata.push({"roleId":role,"menuId":''});
                }
                ...
                $.each(senddata, function(index, val) {
                    params.menuId.push(val.menuId)
                });
                params.menuId=params.menuId.join(',')
                console.log("params"+JSON.stringify(params));
                var jsondata = Restful.postDataR("/ug/use/pburu.do", JSON.stringify(params));


                // console.log("Sendding Data::"+JSON.stringify(senddata));
                // var jsondata = Restful.postDataR("/ugrest/ugsysrolemenu", JSON.stringify(senddata));
