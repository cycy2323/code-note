    ...
    return {
        ...
        init: function () {
            typeHelper=RefHelper.create({
                ref_url:'bdsysrole/?query={"roleType":"1"}',
                ref_col:"roleId",
        ...
        initUnitTree : function(){
            ...
            var reloadRolePerm=function(){
                var data = Restful.findNQ("/ugrest/bdsysrolemenu");
            ...
            var buildMenuData=function(){
                ...
                var roleid = $("#sel_rolecode").val();
                    ...
                    var data = Restful.findNQ('/ugrest/bdsysmenu?query={"status":"1"}');
                    var data1 = Restful.findNQ("/ugrest/bdsysrolemenu");
                    //console.log(data);
                    //console.log(data1);
            ...
            $('#save_button').click(function(){
                ...
                //先删除现有菜单
                var aaa = Restful.delByIDS("/ugrest/bdsysrolemenu",rolemenuId)
                //console.log(aaa);
                ...
                var jsondata = Restful.postDataR("/ugrest/bdsysrolemenu", JSON.stringify(senddata));
