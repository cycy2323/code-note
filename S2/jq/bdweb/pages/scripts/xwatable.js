    ...
    return {
        ...
        init: function(xwajson) {
            ...
            if(!UserInfo.userId()){
                ...
                $.ajax({
                    url: hzq_rest+'bdsysuserconfig/'+userconfigid+'?fields={"configValue":1}',
                    dataType: 'json',
                    async: false
                })
                .done(function(data) {
...
//                                        console.log(val.name+"::ll="+val.checked);
                                ...
                                　　 }
                                    ...
                                    if(sendjson.loginName){
                                        /*var login = Restful.findNQ( hzq_rest + 'bdsysuser/?query={"loginName":"'+sendjson.loginName+'"}');*/
