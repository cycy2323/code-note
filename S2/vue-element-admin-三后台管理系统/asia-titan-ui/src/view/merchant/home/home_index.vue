          ...
          <el-col :xs="12" :sm="12" :md="12" :lg="6" class="card-panel-col">
            <div class="card-panel">
              ...
              <div class="card-panel-description">
                ...
                <!--<count-to :start-val="0" :end-val="withdrawAmount" :duration="3000" :decimals="numberAmount"-->
          ...
          <el-col :xs="12" :sm="12" :md="12" :lg="6" class="card-panel-col">
            <div class="card-panel">
              ...
              <div class="card-panel-description">
                ...
                <!--<count-to :start-val="0" :end-val="rechargeAmount" :duration="3200" :decimals="numberAmount"-->
                <!--class="card-panel-num"/>-->
              </div>
            </div>
          </el-col>
          <el-col :xs="12" :sm="12" :md="12" :lg="6" class="card-panel-col">
            <div class="card-panel">
              ...
              <div class="card-panel-description">
                ...
                <!--<count-to :start-val="0" :end-val="freezeAmount" :duration="3600" :decimals="numberAmount"-->
                <!--class="card-panel-num"/>-->
              </div>
            </div>
          </el-col>
          ...
          <el-col :xs="12" :sm="12" :md="12" :lg="6" class="card-panel-col">
            <div class="card-panel" @click="handleSetLineChartData('shoppings')">
              ...
              <div class="card-panel-description">
                ...
                <!--<count-to :start-val="0" :end-val="remitAmount" :duration="3600" :decimals="numberAmount"-->
                <!--class="card-panel-num"/>-->
                <!--<el-button type="primary" @click="withdrawApply">提现</el-button>-->
              </div>
            </div>
          ...
          <el-col :xs="12" :sm="12" :md="12" :lg="6" class="card-panel-col">
            <div class="card-panel" @click="handleSetLineChartData('shoppings')">
              ...
              <div class="card-panel-description">
                ...
                <!--<count-to :start-val="0" :end-val="payAmount" :duration="3600" :decimals="numberAmount"-->
                <!--class="card-panel-num"/>-->
                <!--<el-button type="primary" @click="withdrawApply">提现</el-button>-->
              </div>
            </div>
