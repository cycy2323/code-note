    ...
    return {
        ...
        reload : function(){
            ...
            var bd={
                ...
                "wheres":"a.area_id in ("+loginarea.join()+") and a.business_type_id ='CHANGEJP' and a.bill_state='3' order by a.accept_date desc,a.finish_date desc",
                "page":true,
                "limit":50
            }
            console.log(bd)
            ...
            xw = XWATable.init(
                {
                                ...
                                return {
                                    f:function(val,row){
                                        if(val){
                                            ...
                                            if(row.reservedField1){
                                                return JSON.parse(row.reservedField1).linkman
                                            }
                                        }
                                    }
                                }
                                ...
                                return {
                                    f:function(val,row){
                                        if(val){
                                            ...
                                            if(row.reservedField1){
                                                return JSON.parse(row.reservedField1).linktel
                                            }
                                        }
                                    }
                                }
                    ...
                    findFilter : function(){
                        ...
                        bd={
                            ...
                            "froms":" gas_csr_busi_register a left join gas_ctm_archive b on b.customer_code = a.customer_code " +
                            "left join gas_mrd_book c on c.book_id=b.book_id",
                            "wheres":sql + " and a.business_type_id ='CHANGEJP' and a.bill_state='3' order by a.accept_date desc,a.finish_date desc",
                            "page":true,
                            "limit":50
                        }
