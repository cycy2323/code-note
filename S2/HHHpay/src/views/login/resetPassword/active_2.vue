<template>
  <div class="login-container">
    <loginHead></loginHead>
    <div class="Paso">
      <img src="../../../assets/images/active_2.png" alt="">
    </div>
    <el-form class="login-form" :label-position="labelPosition" label-width="110px">
    ...
    <el-button type="primary" style="width: 278px; border-radius: 2px;background: #02A5BD;" @click.native.prevent="siguiente">确定</el-button>
  </div>
</template>
...
export default {
  ...
  methods: {
    siguiente () {
      this.$router.push('/login/active_3')
    }
  }
}
</script>
