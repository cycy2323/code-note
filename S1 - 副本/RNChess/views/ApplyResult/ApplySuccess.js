...
export default class ApplySuccess extends BigPopPage {

    //标题
    titleImage = ()=> {
        return require('../../static/images/2.1.0/title20.webp')
    }
    /*跳转到外部浏览器*/
    customerService = () => {
        ...
        return (
            <View style={styles.container}>
                <View style={styles.content}>
                    <FastImage source={require('../../static/images/2.1.0/success.webp')} style={styles.success}/>
