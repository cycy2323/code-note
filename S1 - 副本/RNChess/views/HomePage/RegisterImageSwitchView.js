...
type Props = {};
export default class RegisterImageSwitchView extends Component<Props> {
    constructor(pros) {
        super(pros);
        this.state = {
            dialogActiveStatus: false, //弹窗状态 默认关闭
            resgisterImg:require("../../static/images/2.1.0/bg_registered1.webp")
        }
    }
    ...
    submitBankCard = () =>{
        this.props.openRegisterConfirm();
        this.closePopView();
    }
...
const styles = StyleSheet.create({
    ...
    btnLog: {
        marginTop: 240 * UIMacro.HEIGHT_PERCENT,
